...
.dmvnorm_arma <- function(x, mu, sigma, logd = FALSE) {
    .Call(`_TruncatedNormalBeta_dmvnorm_arma`, x, mu, sigma, logd)
}
...
.dmvt_arma <- function(x, mu, sigma, df, logd = FALSE) {
    .Call(`_TruncatedNormalBeta_dmvt_arma`, x, mu, sigma, df, logd)
}
...
lnNpr <- function(a, b, check = TRUE) {
    .Call(`_TruncatedNormalBeta_lnNpr`, a, b, check)
}
...
.cholpermGB <- function(Sigma, l, u) {
    .Call(`_TruncatedNormalBeta_cholpermGB`, Sigma, l, u)
}
...
.cholpermGGE <- function(Sigma, l, u) {
    .Call(`_TruncatedNormalBeta_cholperm`, Sigma, l, u)
}
...
Phinv <- function(p, l, u) {
    .Call(`_TruncatedNormalBeta_Phinv`, p, l, u)
}
