...
a <- rep(-Inf, n)
b <- rep(-0, n)
# generate samples from the TMVN distribution -------------------------
# samples generated by VMET
time_Vecc_joint <- system.time(samp_Vecc_joint <- mvrandn(
  a, b, mu, locs, "matern15_isotropic", covparms,
  m = 30, N = N, verbose = T
))[[3]]
# samples generated by MET
...
# generate samples from the TMVN distribution section to be faster
